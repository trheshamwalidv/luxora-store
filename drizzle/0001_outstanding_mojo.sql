...
--> statement-breakpoint
CREATE INDEX `campaign_products_campaign_idx` ON `campaign_products` (`campaign_id`);--> statement-breakpoint
CREATE INDEX `campaign_products_product_idx` ON `campaign_products` (`product_id`);--> statement-breakpoint
CREATE INDEX `campaigns_type_idx` ON `campaigns` (`campaign_type`);--> statement-breakpoint
CREATE INDEX `campaigns_published_idx` ON `campaigns` (`is_published`);--> statement-breakpoint
CREATE INDEX `collections_category_idx` ON `collections` (`collection_category`);--> statement-breakpoint
...
CREATE INDEX `variants_size_idx` ON `product_variants` (`size`);--> statement-breakpoint
CREATE INDEX `products_category_idx` ON `products` (`product_category`);--> statement-breakpoint
